...
(function () {
    ...
    MapBuildController.$inject = ['$scope', '$rootScope', '$http', '$filter', 'AddTaskService' , 'MapBuildService', '$uibModal', 'Notification', 'NgTableParams', 'Excel', '$timeout'];
    function MapBuildController($scope, $rootScope, $http, $filter, AddTaskService , MapBuildService, $uibModal, Notification, NgTableParams, Excel, $timeout) {
       ...
       function loadGrid() {
        ...
        function removeMapBuild(MapBuild) {
           // if (MapBuild.run_status === 1) {
                var obj = { s_no : MapBuild.s_no, modified_by : $rootScope.user_id  };
    ...
    MapBuildModelController.$inject = ['$scope', '$rootScope', '$http', '$filter', 'items', '$uibModalInstance', 'Notification', 'MapBuildService', 'AddTaskService'];
    function MapBuildModelController($scope, $rootScope, $http, $filter, items, $uibModalInstance, Notification, MapBuildService, AddTaskService) {
