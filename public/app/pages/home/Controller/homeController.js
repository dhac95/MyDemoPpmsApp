(function () {
    ...
    function HomeController($scope, $rootScope, $http, $filter, AddTaskService, homeService, Notification, SdaReportService) {
        ...
        /* $scope.createBasicChart2 = function () {
            var value1 = [];
            var cat1 = [];
            var id1 = [];
            var id2 = [];
            var cat2 = [];
            var value2 = [];
            for (var k in $scope.ChartList) {
                value1.push($scope.ChartList[k].Count);
                cat1.push($scope.ChartList[k].TaskName);
                id1.push($scope.ChartList[k].total);
            }

            // for(var i in $scope.ChartList2){
            //     value2.push($scope.ChartList2[i].Count);
            //      cat2.push($scope.ChartList2[i].TaskName);
            //       id2.push($scope.ChartList2[i].total);
            // }
